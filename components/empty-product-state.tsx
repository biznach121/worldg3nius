...
export function EmptyProductState({
  ...
  return (
    <div className="relative isolate overflow-hidden border border-black bg-white px-5 py-10 text-black sm:px-8 sm:py-12">
      ...
      <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-[0.86fr_1.14fr] md:items-center">
        <div className="relative mx-auto aspect-[3/4] w-full max-w-[250px] overflow-hidden bg-black text-white">
        ...
        <div>
          ...
          <h2 className="m-0 max-w-2xl font-display text-[clamp(2.4rem,7vw,5.8rem)] uppercase leading-[0.78]">
            {label}
          </h2>
          ...
          <Link
            href="/shop"
            className="mt-7 inline-flex h-12 items-center border border-black bg-black px-5 font-display text-sm uppercase text-white transition-colors hover:bg-white hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black"
          >
            Enter the shop
          </Link>
        </div>
